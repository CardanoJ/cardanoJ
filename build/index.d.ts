...
export declare function buildTransaction(senderAddress: string, receiverAddress: string, lovelace: number, transactionHash: string, transactionId: string): Promise<BuildTransactionResponse>;
...
export declare function getDatumHash(datumValue: number): Promise<DatumResponse>;
...
export declare function getTransactionDetails(senderAddress: string, receiverAddress: string, lovelace: number, txHash: string, txID: string, datumValue: number): Promise<TransactionResponse>;
