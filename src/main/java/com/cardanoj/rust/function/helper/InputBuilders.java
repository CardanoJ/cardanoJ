...
import com.cardanoj.rust.coreapi.util.AssetUtil;
import com.cardanoj.rust.coreapi.util.UtxoUtil;
...
import com.cardanoj.rust.function.TxInputBuilder;
...
public class InputBuilders {
     ...
     * @param utxos         list of <code>{@link Utxo}</code>
     * @param changeAddress change address
     * @param datum         datum object. It can be an instance of <code>{@link PlutusData}</code> or object of a custom class with <code>@{@link com.cardanoj.rust.plutus.annotation.Constr}</code> annotation
     ...
     * @throws com.cardanoj.rust.plutus.exception.PlutusDataConvertionException if datum cannot be converted to PlutusData
     */
