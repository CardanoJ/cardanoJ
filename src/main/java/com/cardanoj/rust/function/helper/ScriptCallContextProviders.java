...
import com.cardanoj.rust.coreapi.config.Configuration;
import com.cardanoj.rust.exception.CborRuntimeException;
...
import com.cardanoj.rust.function.helper.model.ScriptCallContext;
import com.cardanoj.rust.plutus.spec.*;
...
import static com.cardanoj.rust.function.helper.RedeemerUtil.getScriptInputIndex;
...
public class ScriptCallContextProviders {
     ...
     * @param datum Datum as PlutusData or custom Java object (with <code>{@link com.cardanoj.rust.plutus.annotation.Constr}</code> annotation)
     * @param redeemerData Redeemer as PlutusData or custom Java object (with <code>{@link com.cardanoj.rust.plutus.annotation.Constr}</code> annotation)
