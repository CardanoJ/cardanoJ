...
public class RawTransactionHex {
    public static String rawTxnHexGeneration() throws CborSerializationException {

        String transactionId;
        try {
            transactionId = SimpleAdaTransactionBF.transfer().getValue();
        ...
        txnInput.setTransactionId(transactionId);
        txnInput.setIndex(1);
        ...
        String rawHexStr = transaction.serializeToHex();
        System.out.println(rawHexStr);
