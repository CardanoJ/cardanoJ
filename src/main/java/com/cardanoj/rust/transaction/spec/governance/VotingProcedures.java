...
import com.cardanoj.rust.transaction.spec.governance.actions.GovActionId;
...
public class VotingProcedures {
    ...
    @Builder.Default
    private java.util.Map<Voter, java.util.Map<GovActionId, VotingProcedure>> voting = new LinkedHashMap<>();
