package com.cardanoj.rust.transaction.spec.governance.actions;

import co.nstant.in.cbor.model.*;
import com.cardanoj.rust.address.Credential;
import com.cardanoj.rust.spec.UnitInterval;
import com.cardanoj.rust.transaction.util.CredentialSerializer;
import lombok.*;

import java.util.Map;
import java.util.*;

import static com.cardanoj.rust.common.cbor.CborSerializationUtil.toInt;
...
public class UpdateCommittee implements GovAction {
    ...
    public static UpdateCommittee deserialize(Array govActionArray) {
        ...
        Map<Credential, Integer> committeeColdCredEpochMap = new LinkedHashMap<>();
