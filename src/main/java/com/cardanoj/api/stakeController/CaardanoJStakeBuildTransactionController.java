...
import com.cardanoj.api.dto.CardanoJBuildTransactionRequest;

@RestController
@RequestMapping("/api")
public class CaardanoJStakeBuildTransactionController {
    @PostMapping("/build")
    public String getBuildTransaction(@RequestBody CardanoJBuildTransactionRequest request) {
        try {
    ...
    private static String getResourcePath() {
        return CaardanoJStakeBuildTransactionController.class.getClassLoader().getResource("").getPath();
    }
