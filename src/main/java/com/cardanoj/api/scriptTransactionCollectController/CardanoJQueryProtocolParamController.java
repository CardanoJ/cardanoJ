...
@RestController
@RequestMapping("/api")
@Tag(name = "Script Transaction Collect Controller")

public class CardanoJQueryProtocolParamController {

    @GetMapping("/protocolparam")
    @Operation(summary = "Get Protocol Parameters", description = "Retrieve Cardano protocol parameters")
    @ApiResponse(responseCode = "200", description = "Protocol parameters retrieved successfully")
