...
export async function buildTransaction(
    ...
    try {
        ...
        const response = await axios.get<BuildTransactionResponse>(url);
        return response.data;
    } catch (error) {
...
export async function signTransaction(
    ...
    try {
        ...
        const response = await axios.get<SignTransactionResponse>(url);
        return response.data;
    } catch (error) {
...
export async function submitTransaction(
    ...
    try {
        ...
        const response = await axios.get<SubmitTransactionResponse>(url);
        return response.data;
    } catch (error) {
...
export async function getDatumHash(datumValue: number): Promise<DatumResponse> {
    try {
        const url = `http://localhost:8080/api/datum?datumValue=${datumValue}`;
        const response = await axios.get<DatumResponse>(url);
        return response.data;
    } catch (error) {
...
export async function getScriptAddress(cbor: string): Promise<ScriptResponse> {
    try {
        ...
        const response = await axios.get<ScriptResponse>(url);
        return response.data;
    } catch (error) {
...
export async function getProtocolParams(): Promise<ProtocolParamsResponse> {
    try {
        ...
        const response = await axios.get<ProtocolParamsResponse>(url);
        return response.data;
    } catch (error) {
...
export async function buildStakeAddress(paymentKey: string, script: string): Promise<StakeBuildResponse> {
    try {
        ...
        const response = await axios.get<StakeBuildResponse>(url, {
            params
        });
        return response.data;
    } catch (error) {
...
export async function getStakePoolInfo(): Promise<StakePoolResponse> {
    try {
        ...
        const response = await axios.get<StakePoolResponse>(url);
        return response.data;
    } catch (error) {
