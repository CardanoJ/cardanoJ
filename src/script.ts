...
import { getScriptAddress, getScriptTransactionDetails } from './index'; // Adjust this path if needed
...
program
  ...
  .action(async (cbor) => {
    try {
      const scriptAddress = await getScriptAddress("%7b%20%20%20%0a%20%20%20%20%22type%22%3a%20%22PlutusScriptV1%22%2c%0a%20%20%20%20%22description%22%3a%20%22%22%2c%0a%20%20%20%20%22cborHex%22%3a%20%224e4d01000033222220051200120011%22%0a%7d%0a");
...
program
  ...
  .action(async (options) => {
    try {
      ...
      const scriptTransactionDetails = await getScriptTransactionDetails(
        senderAddress,
        receiverAddress,
        lovelace,
        txHash,
